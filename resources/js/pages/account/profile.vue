        ...
        <card title="Update Your Profile">
          <form @submit.prevent="update">
            ...
            <template v-else>
              ...
              <div v-if="success" class="alert alert-success mb-3">Your profile has been updated</div>
...
export default {
  ...
  metaInfo () {
    return { title: 'Update Profile | '+window.config.appName }
  },
  ...
  methods: {
    ...
    update() {
      ...
      // Register the user.
      self.$axios.post('/api/user', self.user).then(function (res) {
